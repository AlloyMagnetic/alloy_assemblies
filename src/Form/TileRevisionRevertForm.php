...
class TileRevisionRevertForm extends ConfirmFormBase {
   ...
   * The Tile revision.
   *
   * @var \Drupal\alloy_assemblies\Entity\TileInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::messenger()->addStatus(t('Tile %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\alloy_assemblies\Entity\TileInterface $revision
