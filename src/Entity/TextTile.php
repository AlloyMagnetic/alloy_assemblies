 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/text_tile/{text_tile}",
 *     "add-form" = "/admin/structure/text_tile/add",
 *     "edit-form" = "/admin/structure/text_tile/{text_tile}/edit",
 *     "delete-form" = "/admin/structure/text_tile/{text_tile}/delete",
 *     "version-history" = "/admin/structure/text_tile/{text_tile}/revisions",
 *     "revision" = "/admin/structure/text_tile/{text_tile}/revisions/{text_tile_revision}/view",
 *     "revision_revert" = "/admin/structure/text_tile/{text_tile}/revisions/{text_tile_revision}/revert",
 *     "revision_delete" = "/admin/structure/text_tile/{text_tile}/revisions/{text_tile_revision}/delete",
 *     "translation_revert" = "/admin/structure/text_tile/{text_tile}/revisions/{text_tile_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/text_tile",
 *   },
